...
//   const [setDeviceId,deviceId] = useState(null)
...
//       setupMediaStream({ video: {deviceId:(deviceId?{exact:deviceId}:undefined), width: { ideal: 1920 }, height: { ideal: 1080 } }, audio: true });
...
//   }, [videoMuted, audioMuted,deviceId]);
...
//         setupMediaStream({ video: { deviceId: { exact: deviceId } }, audio: !audioMuted });
//       };
