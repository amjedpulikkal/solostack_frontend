...
function LandingPage() {
    ...
    return (
        <>
            ...
            <div className='relative' ref={constraintsRef}>
                <div className=' w-full flex justify-center z-30'>
                    <div className=' md:w-1/2 w-full'>
                        ...
                        <p className='text-center zen-dots-regular md:text-[62px]   text-[30px]'>
                            Unlock Your Coding Potential with  Solo<samp className=' text-primary zen-dots-regular '>Stack</samp>
                        </p>
                        <div className=' flex justify-center '>
                            <p className='yantramanav-regular w-80 md:font-[20px] md:mt-0 mt-3  text-center'>
            ...
            <div className='flex justify-center md:mt-3 mt-3'>
            ...
            <div className='md:flex  md:justify-center  gap-7  w-full  px-11 '>
                <motion.div
                    ...
                    <div className='md:w-3/5 h-full md:mt-0 mt-3'>
                        <p className='md:text-[30px] text-[20px] font-semibold'>Breaking Down Barriers in Learning</p>
            ...
            <p className='text-center md:text-[45px] text-[30px] md:px-36 mt-10  font-bold'>
            ...
            <div className='w-full md:flex justify-center md:px-32 mt-10 hidden'>
            ...
            <div className='zen-dots-regular  flex flex-col items-center justify-center text-center pb-32  mt-32 relative  z-50'>
                <div >
