            ...
            <section className="w-screen h-screen flex items-center justify-center ">
                <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
                    ...
                    <div className="w-full py-6 z-20">
                        ...
                        <p className="mt-10 dark:text-gray-100  text-gray-700 ">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                            ...
                            <div className="px-4 pb-2 pt-4">
                                <Button disabled={!!Object.keys(errors).length} type="submit" className="uppercase  w-full h-14 text-lg rounded-full " style={{ backgroundColor: "#28CB8B" }}>{isLoading ? "lording..." : "reset password "}</Button>
                            </div>
