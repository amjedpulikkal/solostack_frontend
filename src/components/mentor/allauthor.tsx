...
import {Iauthor, MentorDB,StudentData} from "@/type"

export const AllAuthors = ({author}:{author:Iauthor}) => {
    const [rowSelection, setRowSelection] = React.useState({})
    const {data} = useSearchAuthors(author) as {data:MentorDB[]|StudentData[]}
